                    ...
                    <div class="feed_body">
                            <div class="clearfix" id="profile-header">
                                <div class="feed_profile_pic pull-left">
                                    <img src="<?php echo Yii::app()->user->getAvatar_url($user->idusuario) ?>" alt="<?php echo CHtml::encode("{$user->apellido_p} {$user->apellido_m}") ?>" class="meta_image" />
                                </div>
                                
                                <h1><?php echo CHtml::encode($user->apellido_p . ' ' . $user->apellido_m) ?></h1>
                                
                                <div class="pull-right" style="margin-top:-5px;">
                                    <?php if(!Yii::app()->user->isGuest): ?>                                     
                                        <?php if(Usuario::isFollowing($user->idusuario)): ?>
                                            <a class="btn btn-primary" href="<?php echo $this->createUrl('site/unfollow', array('id' => $user->idusuario)); ?>"><i class="icon-group"></i> <?php echo Yii::t('yii', 'Unfollow') ?></a>
                                        <?php else: ?>
                                            <a class="btn btn-success" href="<?php echo $this->createUrl('site/follow', array('id' => $user->idusuario)); ?>"><i class="icon-group"></i> <?php echo Yii::t('yii', 'Follow') ?></a>
                                        <?php endif ?>
                                    <?php endif ?>
                                </div>
                            </div>
                            ...
                            <table class="table table-striped">
                                <tr>
                                    ...
                                    <td><?php echo date('d M Y', $user->fechareg) ?></td>
                                </tr>
                                <tr>
                                    <th><?php echo Yii::t('yii', 'Full name') ?></th>
                                    <td><?php echo CHtml::encode("{$user->apellido_p} {$user->apellido_m}") ?></td>
                                </tr>
                                <tr>
