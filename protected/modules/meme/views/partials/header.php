...
<html lang="en" xmlns:fb="http://ogp.me/ns/fb#">
    ...
    <body>
        ...
        <div class="navbar navbar-fixed-top menu-line">
            <div class="navbar-inner">
                <div class="container">
                    ...
                    <div class="nav-collapse collapse">
                        ...
                        Yii::app()->plugin->addMenuItem('top-menu', array('label' => "Memes", 'url' => array("/meme/default/index")));
                        Yii::app()->plugin->addMenuItem('top-menu', array('label' => "Imagenes", 'url' => array('/imagen/index')));
                        Yii::app()->plugin->addMenuItem('top-menu', array('label' => "Posts", 'url' => array('/post/index')));
                        ...
                        Yii::app()->plugin->addMenuItem('top-menu', array('label' => Yii::t('yii', 'Register'), 'url' => array('/usuario/create'), 'visible' => Yii::app()->user->isGuest));
                       Yii::app()->plugin->addMenuItem('top-menu', array(
                                    'label' => '<i class="icon-chevron-down icon-white"></i> Acciones',
                                    'url' => '#',
                                    'visible' => !Yii::app()->user->isGuest,
                                    'itemOptions' => array('class' => 'dropdown', 'id' => 'actions'),
                                    'linkOptions' => array('class' => 'dropdown-toggle', 'data-toggle' => 'dropdown'),
                                    'submenuOptions' => array('class' => 'dropdown-menu'),
                                    'items' => array(
                                        array('label' => Yii::t('yii', 'Create Meme'), 'url' => array('generate/index')),
                                        array('label' => "Crear Post", 'url' => array('/post/create')),
                                        array('label' => "Subir Imagen", 'url' => array('/imagen/create')),
                                        array('label' => Yii::t('yii', 'My Memes'), 'url' => array('site/mymemes')),
                                    )
                        ));
                        Yii::app()->plugin->addMenuItem('top-menu', array(
