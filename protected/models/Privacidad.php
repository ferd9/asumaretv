...
/**
 * This is the model class for table "w_privacidad".
 *
 * The followings are the available columns in table 'w_privacidad':
...
class Privacidad extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('idprivacidad, nombre, code', 'safe', 'on'=>'search'),
		);
	}
