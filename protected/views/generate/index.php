...
Yii::app()->clientScript      
        ->registerScriptFile(Yii::app()->request->baseUrl . '/js/fabric.js')
        ->registerScriptFile(Yii::app()->request->baseUrl . '/js/jquery-ui/js/jquery-ui-1.9.2.custom.min.js')
        ->registerScriptFile(Yii::app()->request->baseUrl . '/js/chosen/chosen/chosen.jquery.min.js')
        ->registerScriptFile(Yii::app()->request->baseUrl . '/js/jquery.iframe-transport.js')
        ->registerScriptFile(Yii::app()->request->baseUrl . '/js/jquery.fileupload.js')
        ->registerScriptFile(Yii::app()->request->baseUrl . '/js/bgrins-spectrum/spectrum.js')
        ->registerScriptFile(Yii::app()->request->baseUrl . '/js/jquery.jcarousel.min.js')
        ->registerScriptFile(Yii::app()->request->baseUrl . '/js/content-scroller/jquery.mCustomScrollbar.concat.min.js')
        ->registerCssFile(Yii::app()->request->baseUrl . '/js/jcarousel-skins/tango/skin.css')
        ->registerCssFile(Yii::app()->request->baseUrl . '/css/jquery.fileupload-ui.css')
        ->registerCssFile(Yii::app()->request->baseUrl . '/js/chosen/chosen/chosen.css')
        ->registerCssFile(Yii::app()->request->baseUrl . '/js/jquery-ui/css/custom-theme/jquery-ui-1.10.0.custom.css')
        ->registerCssFile(Yii::app()->request->baseUrl . '/js/bgrins-spectrum/spectrum.css')
        ->registerCssFile(Yii::app()->request->baseUrl . '/js/content-scroller/jquery.mCustomScrollbar.css')
;
?>
<div class="row">
    <div class="span8">
